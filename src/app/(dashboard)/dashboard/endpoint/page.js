...
export default async function EndpointPage() {
  let machineId = "";
  let settings = { requireApiKey: false, requireLogin: true, tunnelDashboardAccess: false };
  let tunnelStatus = { tunnelUrl: "", publicUrl: "", enabled: false };
  let tailscaleStatus = { tunnelUrl: "", enabled: false };
  let keysData = [];
