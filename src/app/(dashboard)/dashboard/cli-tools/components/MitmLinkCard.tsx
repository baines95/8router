...
export default function MitmLinkCard({ tool }: MitmLinkCardProps) {
 ...
 <Card className="overflow-hidden border-border/50 hover:bg-muted/5 transition-all duration-300 shadow-none">
 <div className="flex items-center justify-between p-4 cursor-pointer select-none">
 <div className="flex items-center gap-4">
 <div className="relative size-10 flex-shrink-0 bg-background border border-border/50 p-1.5 flex items-center justify-center">
 {tool.image ? (
 <Image
 src={tool.image}
 alt={tool.name}
 ...
 <Badge variant="outline" className="h-4 px-1.5 text-[9px] font-bold uppercase bg-primary/10 text-primary border-none tracking-widest">MITM</Badge>
 </div>
